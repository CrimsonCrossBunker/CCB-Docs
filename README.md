...
Retired Lua v5 URLs are generated by `scripts/generate_retired_lua_pages.py`
from the catalog. They link to Platform v1 and to a frozen historical document;
no old CCB checkout, v5 contract, or v5 example is needed to build the site.
Retired pages stay out of navigation, search, and AI indexes.
