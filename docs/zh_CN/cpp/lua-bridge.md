...
documentation_issue_url: https://github.com/CrimsonCrossBunker/CCB-Docs/issues/new?title=docs%28cpp.lua-bridge%29%3A+&body=Document+ID%3A+cpp.lua-bridge%0ALanguage%3A+zh_CN%0AVerified+commit%3A+7d9e60d31d633f5242af229f2e908c22a941c5e2%0A%0ADescribe+the+documentation+problem%3A%0A
---
...
配套测试包括别名去重和真实 Mod 发现测试。此节随源码 PR 保持草稿，合并前核对其最终验证记录。
