...
translation_source_fingerprint: 67c74d1895de516d541002682bee80245cbf9b07aa5b3c5d677a189f3276481a
prerequisites:
- api.lua.v5.overview
depends_on: []
redirect_from: []
...
stale_reason: null
canonical_url: https://crimsoncrossbunker.github.io/CCB-Docs/en/api/lua/v5/reference/functions/
alternate_urls:
...
[Read the previous documentation](https://github.com/CrimsonCrossBunker/CCB-Docs/blob/fd69d0f47ce95fb8e707162b4bac453a2a44ff2b/docs/en/api/lua/v5/reference/functions.md) for historical reference only.
